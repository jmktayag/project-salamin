...
import { SignInFormData } from '../../lib/firebase/auth-types';
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-6">
        <h2 className="gi-heading-2">Welcome back</h2>
      ...
      <div className="mt-6">
        ...
        <button
          ...
          disabled={loading}
          className="mt-3 w-full flex items-center justify-center px-4 py-2 gi-card text-sm font-medium gi-text-secondary hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
